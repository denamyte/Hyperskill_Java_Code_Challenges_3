...
class EmployeesCounter {
    ...
    static Map<Integer, Integer> trashMap;
    static HashMap<Integer, Integer> trashHashMap;
    static Scanner trashScanner;
    static Collectors trashCollectors;
    static Arrays trashArrays;
    static ArrayList<Integer> trashArrayList;
    ...
    public static long calcNumberOfEmployees(List<Department> departments, long threshold) {
        return departments == null ? 0
                : departments.stream().filter(d -> d.getCode().startsWith("111-"))
